...
export const client = new BrowserOAuthClient({
  ...
  clientMetadata: {
    ...
    response_types: ['code'],
    scope: 'atproto rpc:app.bsky.graph.getFollows?aud=did:web:api.bsky.app#bsky_appview rpc:app.bsky.graph.getList?aud=did:web:api.bsky.app#bsky_appview rpc:app.bsky.actor.getProfile?aud=did:web:api.bsky.app#bsky_appview rpc:com.atproto.identity.resolveHandle',
